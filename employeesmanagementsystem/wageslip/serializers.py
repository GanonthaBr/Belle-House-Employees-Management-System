...
class InvoiceSerializer(ModelSerializer):
    ...
    class Meta:
        model = Invoice
        fields = ['id','topic','name','date','number','echeance','client','client_id','tax','type_tax','tax_amount','payment_mode','designations','montant_avance','total_amount','total','net_to_pay','stamp']
